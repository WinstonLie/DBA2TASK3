public class constants{
    ...
    public static final int HEAP_PAGE_NUM = 4;
    public static final int HEAP_PAGE_POSITION = 4;
    public static final int INDEX_RECORD_SIZE = STD_NAME_SIZE + 
    											HEAP_PAGE_NUM +
    											HEAP_PAGE_POSITION;
    ...
    public static final int COUNTS_OFFSET = STD_NAME_SIZE + 
                                            ...
                                            SENSORID_SIZE + 
                                            SENSORNAME_SIZE;    
    public static final int TREE_ORDER = 3;
    
    public static final double KEY_ONE = 0.25;
    
    public static final double KEY_TWO = 0.5;
    
    public static final double KEY_THREE = 0.75;
    
    public static final double KEY_FOUR = 1;
